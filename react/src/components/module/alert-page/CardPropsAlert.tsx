...
const CardPropsAlert = () => {
  const listItem: TItemList[] = [
    ...
    },
    {
      ...
      content: (
        <>
          Determines the type of alert. Accepts <span className="italic">error</span>, <span className="italic">success</span>, <span className="italic">warning</span>, <span className="italic">notification</span>, <span className="italic">info</span>.
        </>
      ),
    },
    {
      ...
      content: (
        <>
          If <span className="italic">true</span>, displays an icon associated with the alert type (<span className="italic">IconInfo</span>, <span className="italic">IconDanger</span>, <span className="italic">IconSuccess</span>, <span className="italic">IconNotification</span>,{" "}
          <span className="italic">IconClose</span>).
        </>
      ),
    },
    {
