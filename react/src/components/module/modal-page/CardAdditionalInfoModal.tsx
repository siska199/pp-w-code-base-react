...
const CardAdditionalInfoModal = () => {
  const listAdditionalInfo = [
...

    {
      ...
      caption: (
        <p>
          The component relies on the &apos;@assets/styles/ui/modal.css&apos; file for its styles. Ensure that this CSS file is correctly imported and included in your project. You can see the file <Here to="/" />{" "}
        </p>
      ),
    },
    {
