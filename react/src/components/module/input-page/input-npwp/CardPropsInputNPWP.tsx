...
const CardPropsInputNPWP = () => {
  const listItem = [
    ...
    },
    {
      ...
      content: (
        <>
          To see all available props that ContainerInput have you can see in <Button label="here" to={`/docs/prerequisite/helper-component?id=container-input.tsx`} />{" "}
        </>
      ),
    },
  ];
...
export default CardPropsInputNPWP;
