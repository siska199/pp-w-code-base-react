...
const CardIntroAvatar = () => {
    ...
    const listExample = [
        {
            component: <CardVariousCompVariant<typeof variantsAvatar.variant>
        ...
        {
            title: 'Size',
            component: <CardVariousCompVariant<typeof variantsAvatar.size>
        ...
        {
            title: 'Shape',
            component: <CardVariousCompVariant<typeof variantsAvatar.shape>
        ...
        {
            title: 'Status',
            component: <CardVariousCompVariant<typeof variantsAvatar.status>
