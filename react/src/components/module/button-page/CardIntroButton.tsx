...
const CardIntroButton = () => {
  const listExample = [
    {
      title: "Color",
      component: <CardVariousCompVariant<typeof variantButton> variant={variantButton} groups={["solid", "outline", "soft", "softborder"]} Component={(variant) => <Button variant={variant} label={"Siska"} />} />,
    },
    {
      title: "Size",
      component: (
