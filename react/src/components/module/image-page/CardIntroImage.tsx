...
const CardIntroImage = () => {
  ...
  const listExample = [
    {
      ...
      component: (
        <div className="flex flex-col gap-2">
          ...
          />
          <CardVariantComp title={"Access image from url "} withBorder={false} Component={<Image src={"https://i.pinimg.com/564x/c1/31/c8/c131c80be697650f1311229b81405aa2.jpg"} className="h-[10rem] w-[10rem] object-cover" />} customeClass={{ container: "!gap-8 [&>p]:!text-left" }} />
        </div>
      ),
    },
    {
            ...
            Component={
              <Image
                ...
                overlay={{
                  withBackdrop: true,
                  content: (
                    <div className="text-white items-end flex w-full h-full p-3 gap-3">
          ...
          <CardVariantComp
            ...
            Component={
              <div className="flex flex-col gap-4 items-center    mx-auto">
                ...
                {showImageWithSkeleton && <Image src={"https://i.pinimg.com/564x/c1/31/c8/c131c80be697650f1311229b81405aa2.jpg"} className="h-[10rem] w-[10rem] object-cover" timeoutLoadImage={3600} withSkeleton={true} />}
              </div>
            }
            customeClass={{ container: "!gap-8  [&>p]:!text-left " }}
          />
          <CardVariantComp
            ...
            Component={
              <div className="flex flex-col gap-4 items-center    mx-auto">
                ...
                {showImageWithBlur && <Image src={"https://i.pinimg.com/564x/c1/31/c8/c131c80be697650f1311229b81405aa2.jpg"} className="h-[10rem] w-[10rem] object-cover" timeoutLoadImage={3600 * 5} />}
              </div>
            }
            customeClass={{ container: "!gap-8  [&>p]:!text-left " }}
          />
  ...
  return <CardIntroComponent title={"Image"} subTitle="Component Image is a component used to display images with additional features such as loading states, overlays, and skeleton loading. " listExample={listExample} displayCodeBase={displayCodeBase} />;
};
