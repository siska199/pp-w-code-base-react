...
const CardAdditionalInfoTable = () => {
  const listAdditionalInfo = [
    ...
    },
    {
      ...
      caption: <p>
        To use this table component with the `useTable` hook, first initialize the hook with necessary parameters such as `initialColumn`, `initialData`, `initialSetting`, and `onFetchData`. The hook will manage table data, settings, and provide necessary handlers for sorting, pagination, and data fetching.
        <span>You can see the hook file in <Button label="here" to="/" /></span>
      </p>
    }
  ];
