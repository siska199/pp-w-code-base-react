  ...
  const listAdditionalInfo = [
    {
      ...
      caption: (
        <p>
          The default layout of the Card component is &lsquo;vertical&lsquo;. The default variant is &lsquo;top-bordered&lsquo;, and the default fit is &lsquo;true&lsquo;, meaning the card width will adjust to fit its content. These defaults can be changed by specifying the respective props.
        </p>
      ),
    },
    {
