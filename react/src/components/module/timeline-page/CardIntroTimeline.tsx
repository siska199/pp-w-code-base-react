...
const CardIntroTimeline = () => {
  ...
  const listExample = [
    {
      title: "Variant 1",
      component: <div className="w-full overflow-x-auto flex justify-center">
        <Timeline listStep={listStep} customeClass={{ containerContent: "w-[12rem]" }} />
      </div>
    },
    {
      title: "Variant 1",
      component: <div className="w-full overflow-x-auto">
