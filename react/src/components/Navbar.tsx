    ...
    return (
        <nav id="navbar" className="bg-blur  w-full sticky  z-[9] flex items-center justify-between white top-0 left-0 border-b px-8 py-4">
            <div className="flex items-center gap-8">
                ...
                <Breadcrumb items={listMenuNavbar} withIconDivider={false} className={"gap-8 hidden md:flex"} customeClass={{active: "bg-primary-50 text-primary-700 !px-2 !rounded-md" }} />
            </div>
            <div>
