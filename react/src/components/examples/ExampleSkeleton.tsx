...
const ExampleSkeleton = () => {
    return (
        <div className="p-4">
            ...
            <div role="status" className="max-w-sm p-4 border border-gray-400 rounded shadow animate-pulse md:p-6 ">
                ...
                <div className="h-2 bg-gray-400 rounded-full  mb-2"></div>
                <div className="h-2 bg-gray-400 rounded-full  mb-2"></div>
                <div className="h-2 bg-gray-400 rounded-full "></div>
                <div className="flex items-center mt-4">
                    <svg className="w-10 h-10 me-3 text-gray-400 d" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
