    ...
    },
    {
      ...
      caption: (
        <Container gap={"small"}>
          ...
          <p>then, add <span className="italic">tsconfigPaths()</span> object plugins in file  <Filename name="vite.config.js" /> </p>
          <CodeBlock fileName="vite.config.ts" codeString={`...\r\nplugins: [..., tsconfigPaths()],\r\n...`} />
          <p>last, add this below code in object compilerOptions in file <Filename name="tsconfig.json" /> </p>
    ...
    },
    {
      ...
      caption: (
        <Container gap={"small"}>
          ...
          <p>add <span className="italic">svgr()</span> object plugins in file <Filename name="vite.config.js" />. </p>
          <CodeBlock fileName="vite.config.ts" codeString={`...\r\nplugins: [..., svgr(),]\r\n...`} />
          <p>then, add below code in file <Filename name="vite-env.d.ts" />. </p>
          <CodeBlock fileName="vite.config.ts" codeString={`...\r\n/// <reference types="vite-plugin-svgr/client" />\r\n...`} />
          <p>last, add this css in file <Filename name="index.css" />. For icon with type outline you can dynamically change the color using class that have format <span className="italic">icon-[type]</span>, meanwhile
