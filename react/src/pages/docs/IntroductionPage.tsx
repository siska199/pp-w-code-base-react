...
const IntroductionPage = () => {
    const listItemSubMenu1 = [
        ...
        },
        {
            ...
            content: "Designed with developers in mind, Code Base React 199 provides the tools and guidelines needed to build scalable and maintainable applications from scratch."
        },
    ]
    return (
        <>
            <CardIntro
                title={'Introduction'}
                subTitle={<>
                    Code Base React 199 is designed to ease developers into building react applications from scratch, providing a comprehensive reference for code structure and component design. Unlike traditional component libraries, Code Base React 199 offers ready-to-use code snippets that you can copy, paste, and customize to fit your specific needs. Although these snippets are ready to use, there are a few important prerequisites to keep in mind.
                    Therefore, it is essential <Button variant={"link-gray"} to={"/docs/prerequisite/library"} label={'to read the prerequisites'} /> before using Code Base React 199.
                </>}
            />
            <CardSubMenu title="Why we create code base react 199" customeClass={{ title: "border-b-0", container: "gap-0" }}>
                <p>
                    The creator of Code Base React 199, a seasoned developer, has often faced the challenges of starting projects from scratch, especially in frontend development. Developers are frequently left without the support of a UI/UX design system, making it difficult to anticipate the variations and future requirements of components. As projects evolve and new component variants are needed, maintaining and enhancing the codebase can become a daunting task, sometimes causing issues with existing code.
                    Code Base React 199 provides developers with a clear picture of all possible component variations when creating a new component. This foresight helps in designing flexible and scalable components from the start.
                </p>
            </CardSubMenu>
            <CardSubMenu title="What Makes Code Base React 199 Unique?" customeClass={{ title: "border-b-0", container: "gap-0" }}>
                <p>Code Base React 199 sets itself apart with a unique blend of features designed to enhance your development experience:</p>
                <List items={listItemSubMenu1} />
            </CardSubMenu>
            <CardSubMenu title="Why Code Base React 199?" customeClass={{ title: "border-b-0", container: "gap-0" }}>
                <p>
                    As developers, we understand the challenges of starting from scratch. Our goal is to provide a one-stop reference for developers, making it easier to structure and maintain codebases. Code Base React 199 is your go-to resource for finding well-organized, reliable code snippets that help you build better applications.
                </p>
            </CardSubMenu>
